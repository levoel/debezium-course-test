...
flowchart TB
    subgraph DOCKER["Docker Compose Stack"]
        ...
        subgraph STREAMING["Streaming Layer"]
            ...
            CONNECT[Debezium Connect<br/>:8083]
        end
        ...
        subgraph EXERCISES["Exercises"]
            JUP[JupyterLab<br/>:8888]
        end

        PG -->|WAL| CONNECT
        CONNECT -->|Events| KAFKA
        KAFKA --> SR
        CONNECT -->|Metrics| PROM
        PROM --> GRAF
        KAFKA -->|Consume| JUP
        PG -->|Query| JUP
    end
    ...
    style CONNECT fill:#10b981
    style JUP fill:#f59e0b
    style GRAF fill:#ec4899
