...
1. Primary region работает нормально, Debezium читает binlog с lag <1 second
...
3. **Seconds Since Last Event** (Stat panel)
   ...
   - Thresholds: <10s=Green, 10-60s=Yellow, >60s=Red
...
- Wait for alarm to enter `OK` state (lag <300s)
