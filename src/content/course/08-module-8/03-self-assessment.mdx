...
**Полезные ресурсы:**
- [Multi-Database Architecture](/course/module-7/04-multi-database-architecture) — сравнение separate topics vs unified topics patterns
- [Multi-Database Configuration](/course/module-7/05-multi-database-configuration) — практическая имплементация
