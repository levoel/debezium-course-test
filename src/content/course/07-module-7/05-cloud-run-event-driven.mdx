...
import { PubSubEventarcCloudRunDiagram, AutoScalingBehaviorSequence, EndToEndEventProcessingSequence, CloudRunProjectStructureDiagram } from '../../../components/diagrams/module7';
...
<PubSubEventarcCloudRunDiagram client:load />
...
<CloudRunProjectStructureDiagram client:visible />
...
<AutoScalingBehaviorSequence client:visible />
...
<EndToEndEventProcessingSequence client:visible />
