...
1. **Outbox Pattern:** [Module 4 - Outbox Pattern](/course/module-4/03-outbox-pattern)
2. **Outbox Event Router SMT:** [Module 4 - Outbox Pattern](/course/module-4/03-outbox-pattern)
3. **PyFlink Table API:** [Module 5 - PyFlink Basics](/course/module-5/02-pyflink-basics)
4. **Debezium Format:** [Module 5 - PyFlink Basics](/course/module-5/02-pyflink-basics)
5. **BigQuery CDC:** [Module 6 - Dataflow CDC to BigQuery](/course/module-6/02-dataflow-cdc-bigquery)
6. **Monitoring Setup:** [Module 3 - Metrics and Monitoring](/course/module-3/01-metrics-monitoring)
