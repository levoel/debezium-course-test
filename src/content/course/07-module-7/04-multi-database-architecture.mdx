...
В [предыдущих уроках модуля 7](/course/module-7/01-capstone-overview) вы проектировали CDC pipeline для **одного источника** — PostgreSQL или MySQL. В реальных enterprise системах часто требуется **объединять события из нескольких баз данных** в единый аналитический поток.
...
- [GTID Mode Fundamentals](/course/module-8/02-gtid-mode-fundamentals) — Понимание GTID vs binlog file:position
- [Binlog vs WAL Comparison](/course/module-8/05-binlog-wal-comparison) — Архитектурные различия PostgreSQL vs MySQL
- [Schema History Recovery](/course/module-8/06-schema-history-recovery) — MySQL schema history topic backup и recovery
- [Multi-Connector Deployments](/course/module-8/14-multi-connector-deployments) — database.server.id registry и unique identifier management

**Next Lesson:**
- [Multi-Database Configuration](/course/module-7/05-multi-database-configuration) — Hands-on implementation паттернов из этого урока
