...
import { MonitoringComponentsDiagram, MonitoringPointsHierarchyDiagram, AlertFlowDiagram, CdcDashboardStructureDiagram } from '../../../components/diagrams/module7';
...
<CdcDashboardStructureDiagram client:visible />
