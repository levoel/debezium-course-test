...
В [Module 3 Production Operations](/course/module-3) мы работали с Prometheus и Grafana для локального мониторинга Debezium. Здесь мы применяем те же концепции, но используем **Cloud Monitoring** — управляемый сервис GCP с интеграцией всех компонентов.
...
graph TD
    subgraph "Dashboard Layout"
        subgraph "Row 1: Health Indicators"
            H1[🟢 Cloud SQL<br/>Healthy]
            H2[🟢 Debezium<br/>Healthy]
            H3[🟡 Pub/Sub<br/>Warning]
            H4[🟢 Dataflow<br/>Healthy]
            H5[🔴 Cloud Run<br/>Critical]
        end
