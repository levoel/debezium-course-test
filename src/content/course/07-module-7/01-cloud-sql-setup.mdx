...
DMS выглядит дешевле на голом инфра-уровне для среднего workload, но переход на >50K events/sec обычно делает self-hosted экономичнее. Главное правило: для AWS-only стартапов с командой <10 человек -- DMS; для multi-cloud / data-platform-team -- Debezium.
