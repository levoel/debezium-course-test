...
<KnowledgeCheck
  ...
  answer="pgoutput встроен в PostgreSQL 10+ и не требует установки дополнительного ПО. Он работает на всех managed PostgreSQL (Aurora, RDS, Cloud SQL). wal2json — сторонний плагин, который часто невозможно установить на managed-сервисах."
/>
