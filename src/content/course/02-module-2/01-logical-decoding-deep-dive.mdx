...
```mermaid
graph TD
    subgraph WAL["WAL Record"]
        LSN["LSN: 0/1A3B4C0"]
        TXN["Transaction ID: 12345"]
        TS["Timestamp: 2026-02-01 10:30:00.123"]
        OP["Operation: UPDATE"]
        REL["Relation: public.customers (OID: 16384)"]
        OLD["Old tuple key: {id: 1}"]
        NEW["New tuple: {id: 1, name: 'Alice', email: '...'}"]
    end

    LSN --- TXN --- TS --- OP --- REL --- OLD --- NEW
```
