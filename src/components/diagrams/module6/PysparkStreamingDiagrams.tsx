    ...
    >
      <div class="flex flex-col gap-4">
        ...
        <div class="flex items-center gap-2">
          <div class="text-xs text-[var(--ink-muted)] w-20">10:00</div>
          <div class="flex-1 h-px bg-[var(--bg-deep)]" />
        </div>

        <div class="flex flex-col gap-3">
          <div class="flex items-center gap-3">
            <div class="text-xs text-[var(--ink-muted)] w-20">10:01</div>
            <DiagramTooltip
              content={
                <div>
          ...
          <div class="flex items-center gap-3">
            <div class="text-xs text-[var(--ink-muted)] w-20">10:03</div>
            <DiagramTooltip
              content={
                <div>
                  <strong>On-time Event</strong>
          ...
          <div class="flex items-center gap-2">
            <div class="text-xs text-amber-400 w-20">10:05</div>
            <div class="flex-1 h-px bg-amber-600" />
            <span class="text-xs text-amber-700">Watermark threshold</span>
          </div>

          <div class="flex items-center gap-3">
            <div class="text-xs text-[var(--ink-muted)] w-20">10:10</div>
            <DiagramTooltip
              content={
                <div>
        ...
        <div class="mt-2 text-sm text-amber-400 border-l-2 border-amber-400 pl-3">
          ...
          <p class="mt-1 text-[var(--ink-default)]">
            <code class="text-xs bg-[var(--bg-sunken)] px-2 py-1 rounded">
