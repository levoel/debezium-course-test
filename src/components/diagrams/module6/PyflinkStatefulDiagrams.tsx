      ...
      >
        <div class="flex flex-col items-center gap-3">
          ...
          >
            ...
            >
              Aggregations<br />
              <span class="text-xs text-[var(--ink-muted)]">(COUNT, SUM, AVG)</span>
            </FlowNode>
          </DiagramTooltip>
  ...
  return (
    ...
    >
      <div class="flex flex-col gap-4">
        ...
        <div class="flex items-center justify-center gap-2 flex-wrap">
          <DiagramTooltip
            content={
              <div>
                <strong>10:00</strong>
                <p class="mt-1">Начало timeline. События прибывают.</p>
              </div>
            }
          >
            <FlowNode
          ...
          <DiagramTooltip
            content={
              <div>
                <strong>10:01</strong>
                <p class="mt-1">События с event_time=10:01 обработаны.</p>
              </div>
            }
          >
            <FlowNode
          ...
          <DiagramTooltip
            content={
              <div>
                <strong>10:04</strong>
                <p class="mt-1">Будущие события ещё не прибыли.</p>
              </div>
            }
          >
            <FlowNode
        ...
        <div class="mt-2 text-sm text-amber-400 border-l-2 border-amber-400 pl-3">
      ...
      <div class="flex flex-col gap-4">
        <div class="flex items-center justify-center gap-2 flex-wrap">
          ...
          >
            ...
            >
              10:00-10:05<br />
              <span class="text-xs text-[var(--ink-muted)]">Window 1</span>
            </FlowNode>
          </DiagramTooltip>
          ...
          >
            ...
            >
              10:05-10:10<br />
              <span class="text-xs text-[var(--ink-muted)]">Window 2</span>
            </FlowNode>
          </DiagramTooltip>
          ...
          <DiagramTooltip
            content={
              <div>
                ...
                <p class="mt-1">Третье окно. Паттерн продолжается.</p>
              </div>
            }
          >
            <FlowNode
            ...
            >
              10:10-10:15<br />
              <span class="text-xs text-[var(--ink-muted)]">Window 3</span>
            </FlowNode>
          </DiagramTooltip>
          ...
          >
            ...
            >
              10:15-10:20<br />
              <span class="text-xs text-[var(--ink-muted)]">Window 4</span>
            </FlowNode>
          </DiagramTooltip>
        </div>

        <div class="text-sm text-blue-400 border-l-2 border-blue-400 pl-3">
          ...
          <p class="mt-2 text-[var(--ink-default)]">
    ...
    >
      <div class="flex flex-col gap-4">
        <div class="flex items-center justify-center gap-2 flex-wrap">
          ...
          <div class="text-[var(--ink-subtle)] text-sm px-2">overlap →</div>
        ...
        <div class="text-sm text-purple-400 border-l-2 border-purple-400 pl-3">
          <strong>Характеристики:</strong>
          <p class="mt-1 text-[var(--ink-default)]">
  ...
  return (
    ...
    >
      <div class="flex flex-col gap-4">
        ...
        <div class="flex flex-col gap-2">
          ...
          <div class="flex items-center gap-2 flex-wrap">
            ...
            >
              ...
              >
                Gap: 30 min<br />
                <span class="text-xs text-[var(--ink-muted)]">(inactivity)</span>
              </FlowNode>
            </DiagramTooltip>
        ...
        <div class="text-sm text-emerald-400 border-l-2 border-emerald-400 pl-3">
          <strong>Характеристики:</strong>
          <p class="mt-1 text-[var(--ink-default)]">
    ...
    >
      <div class="flex flex-col items-center gap-3">
        ...
        <div class="mt-4 text-sm text-rose-400 border-l-2 border-rose-400 pl-3">
          ...
          <ul class="mt-1 list-disc list-inside text-[var(--ink-default)]">
            <li>
