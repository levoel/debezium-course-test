  ...
  return (
    ...
    >
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          <div
            class="p-4 rounded-lg bg-emerald-500/20 border-2 border-emerald-400/30 cursor-pointer hover:border-emerald-400"
            tabindex={0}
          >
            <div class="text-lg font-bold text-emerald-700">BACKWARD</div>
            <div class="text-sm text-[var(--ink-default)] mt-2">
              Old consumer + New data
            </div>
            <div class="text-xs text-emerald-400 mt-2">✅ Compatible</div>
        ...
        >
          <div
            class="p-4 rounded-lg bg-blue-500/20 border-2 border-blue-400/30 cursor-pointer hover:border-blue-400"
            tabindex={0}
          >
            <div class="text-lg font-bold text-blue-700">FORWARD</div>
            <div class="text-sm text-[var(--ink-default)] mt-2">
              New consumer + Old data
            </div>
            <div class="text-xs text-blue-400 mt-2">✅ Compatible</div>
            <div class="text-xs text-[var(--ink-muted)] mt-1">
        ...
        >
          <div
            class="p-4 rounded-lg bg-purple-500/20 border-2 border-purple-400/30 cursor-pointer hover:border-purple-400"
            tabindex={0}
          >
            <div class="text-lg font-bold text-purple-700">FULL</div>
            <div class="text-sm text-[var(--ink-default)] mt-2">
              Both directions compatible
            </div>
            <div class="text-xs text-purple-400 mt-2">✅ Max safety</div>
            <div class="text-xs text-[var(--ink-muted)] mt-1">
        ...
        >
          <div
            class="p-4 rounded-lg bg-rose-500/20 border-2 border-rose-400/30 cursor-pointer hover:border-rose-400"
            tabindex={0}
          >
            <div class="text-lg font-bold text-rose-700">NONE</div>
            <div class="text-sm text-[var(--ink-default)] mt-2">No compatibility check</div>
            <div class="text-xs text-rose-400 mt-2">⚠️ No validation</div>
            <div class="text-xs text-[var(--ink-muted)] mt-1">
      ...
      <div class="flex flex-col items-center gap-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div class="flex flex-col items-center gap-3">
            ...
            <div class="text-xs text-[var(--ink-muted)] text-center mt-2">
          ...
          <div class="flex flex-col items-center gap-3">
            ...
            <div class="text-xs text-rose-400 text-center mt-2">
        ...
        <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
          ...
          <div class="p-4 rounded-lg bg-emerald-500/10 border border-emerald-400/30">
            <div class="text-sm font-bold text-emerald-700">
              ✅ Безопасные изменения
            </div>
            <ul class="mt-2 text-xs text-[var(--ink-default)] space-y-1">
          ...
          <div class="p-4 rounded-lg bg-rose-500/10 border border-rose-400/30">
        ...
        <div class="mt-4 text-sm text-blue-400 border-l-2 border-blue-400 pl-3">
