      ...
      <div class="flex flex-col items-center gap-4">
        ...
        <div class="flex gap-8 mt-4">
          ...
          <div class="flex flex-col items-center gap-2">
            <div class="text-sm font-semibold text-emerald-400">TRUE</div>
            <Arrow direction="down" />
            <DiagramTooltip
              content={
                <div>
          ...
          {/* FALSE path */}
          <div class="flex flex-col items-center gap-2">
            <div class="text-sm font-semibold text-[var(--ink-muted)]">FALSE</div>
            <Arrow direction="down" />
            <DiagramTooltip
              content={
                <div>
        ...
        >
          <div class="flex flex-col items-center gap-3">
            ...
            <div class="flex items-center gap-2">
              <div class="text-xs text-emerald-400 font-semibold">TRUE →</div>
              <DiagramTooltip
                content={
                  <div>
    ...
    >
      <div class="flex flex-col items-center gap-4">
        ...
        <div class="flex gap-8 mt-4">
          {/* NO path - Predicates */}
          <div class="flex flex-col items-center gap-2">
            <div class="text-sm font-semibold text-emerald-400">НЕТ</div>
            <div class="text-xs text-[var(--ink-muted)]">(только topic/tombstone/header)</div>
            <Arrow direction="down" />
            ...
            >
              ...
              >
                ...
                <div class="text-xs text-[var(--ink-muted)] mt-2">Примеры:</div>
                <div class="text-xs text-[var(--ink-muted)]">- TopicNameMatches</div>
                <div class="text-xs text-[var(--ink-muted)]">- RecordIsTombstone</div>
                <div class="text-xs text-[var(--ink-muted)]">- HasHeaderKey</div>
              </FlowNode>
            </DiagramTooltip>
          </div>
          ...
          <div class="flex flex-col items-center gap-2">
            <div class="text-sm font-semibold text-blue-400">ДА</div>
            <div class="text-xs text-[var(--ink-muted)]">(нужен доступ к value.after)</div>
            <Arrow direction="down" />
            ...
            <div class="flex gap-6 mt-3">
              {/* YES - Filter SMT */}
              <div class="flex flex-col items-center gap-2">
                <div class="text-xs font-semibold text-blue-400">ДА</div>
                <Arrow direction="down" />
                ...
                >
                  ...
                  >
                    <div>Filter SMT</div>
                    <div class="text-xs text-[var(--ink-muted)] mt-2">+ Groovy condition</div>
                    <div class="text-xs text-[var(--ink-muted)] mt-2">Примеры:</div>
                    <div class="text-xs text-[var(--ink-muted)]">- value.op == 'c'</div>
                    <div class="text-xs text-[var(--ink-muted)]">- value.after.status == 'ACTIVE'</div>
                  </FlowNode>
                </DiagramTooltip>
              </div>
              ...
              <div class="flex flex-col items-center gap-2">
                ...
                <div class="text-xs text-[var(--ink-muted)]">(сложная логика)</div>
                <Arrow direction="down" />
                ...
                >
                  ...
                  >
                    ...
                    <div class="text-xs text-[var(--ink-muted)] mt-2">или ksqlDB</div>
                    <div class="text-xs text-[var(--ink-muted)] mt-2">Для:</div>
                    <div class="text-xs text-[var(--ink-muted)]">- Сложная логика</div>
                    <div class="text-xs text-[var(--ink-muted)]">- Агрегации</div>
                    <div class="text-xs text-[var(--ink-muted)]">- Joins</div>
                  </FlowNode>
                </DiagramTooltip>
              </div>
            </div>
