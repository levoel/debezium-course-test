  ...
  return (
    <div class="my-8 space-y-4">
      ...
      <DiagramContainer title="Embedded Engine" color="rose">
        <div class="flex items-center justify-center gap-2 flex-wrap pb-6">
          <DiagramTooltip content="Исходная база данных с WAL/binlog для захвата изменений">
            <FlowNode variant="database" tabIndex={0}>Database</FlowNode>
          </DiagramTooltip>
          <Arrow />
          ...
          <div class="relative">
            ...
            <p class="absolute left-1/2 -translate-x-1/2 top-full mt-1.5 text-xs text-[var(--ink-muted)] whitespace-nowrap">Custom Processing</p>
          </div>
        </div>
      </DiagramContainer>
    </div>
