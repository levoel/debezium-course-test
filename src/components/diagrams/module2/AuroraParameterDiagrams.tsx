  ...
  return (
    <div class="space-y-6">
      ...
      <div class="flex flex-col items-center gap-4">
        <div class="text-sm text-[var(--ink-muted)] text-center">
        ...
        <div class="text-xs text-[var(--ink-subtle)] text-center">
  ...
  return (
    <div class="space-y-6">
      ...
      <DiagramContainer title="Критическое предупреждение" color="rose" className="max-w-2xl mx-auto">
        <div class="text-sm text-[var(--ink-default)] text-center space-y-2">
          ...
          <div class="text-xs text-[var(--ink-muted)]">
            ...
            <br />
            <code class="bg-[var(--bg-sunken)] px-1 rounded text-[11px]">SHOW wal_level;</code> покажет <code class="bg-[var(--bg-sunken)] px-1 rounded text-[11px]">replica</code> вместо <code class="bg-[var(--bg-sunken)] px-1 rounded text-[11px]">logical</code>
            <br />
      ...
      <DiagramContainer title="Проверка после настройки" color="emerald" className="max-w-lg mx-auto">
        <div class="text-[11px] text-[var(--ink-muted)] space-y-1 font-mono">
